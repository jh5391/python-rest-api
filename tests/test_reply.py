...
def test_create_reply(authorized_client, test_user, test_posts, post_id, comment):
    res = authorized_client.post("/replys/", json={"post_id": post_id, "comment": comment})
...
def test_update_other_user_reply(authorized_client, test_user, test_user2, test_posts, test_replys2):
    data = {
